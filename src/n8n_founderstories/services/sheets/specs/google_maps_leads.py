"""
Google Maps Leads sheet specification.

Declarative configuration for the Google Maps Leads Google Sheets tab.
...
Usage:
    from services.sheets.specs import google_maps_leads
    
    # Access configuration
    headers = google_maps_leads.HEADERS
    tab_name = google_maps_leads.TAB_NAME
"""
...
"""Name of the Google Sheets tab for Google Maps Places lead data."""

# ============================================================================
# COLUMN CONFIGURATION
# ============================================================================

HEADERS = ["Organization", "Domain", "Location", "Search Query"]
"""
Column headers for the Google Maps Leads sheet.

Columns:
- Organization: Business name from Google Places
- Domain: Extracted website domain
- Location: Geographic location (country/region/city)
- Search Query: Search term that found this place
"""

COLUMN_WIDTHS_PX = [320, 320, 240, 320]
...
H_ALIGN_PER_COLUMN = ["LEFT", "LEFT", "CENTER", "CENTER"]
"""
Horizontal alignment per column for data rows.

- Organization & Domain: LEFT aligned (text-heavy)
- Location, Search Query: CENTER aligned (categorical)
"""
...
DATA_WRAP_PER_COLUMN = ["CLIP", "CLIP", "CLIP", "WRAP"]
"""
Text wrap strategy per column for data rows.

- Organization, Domain, Location: CLIP (prevent row expansion)
- Search Query: WRAP (allow multi-line for long queries)
"""
